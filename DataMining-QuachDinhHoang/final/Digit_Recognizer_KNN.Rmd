...
When we train the models with the entire train set, we will get a better result (higher accuracy) on a larger test set. We will examine this at the end of this report.